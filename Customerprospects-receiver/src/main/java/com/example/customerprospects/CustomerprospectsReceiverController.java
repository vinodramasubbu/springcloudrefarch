...
@RestController
public class CustomerprospectsReceiverController {

    private static final Logger LOGGER = LoggerFactory.getLogger(CustomerprospectsReceiverController.class);
    private static final String INPUT_CHANNEL = "queue.input";
    private static final String QUEUE_NAME = "customerprospects";

    /**
     * This message receiver binding with
     * {@link ServiceBusQueueInboundChannelAdapter}
